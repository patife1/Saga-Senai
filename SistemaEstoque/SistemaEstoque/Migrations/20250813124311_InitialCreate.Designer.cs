...
namespace SistemaEstoque.Migrations
{
    ...
    [Migration("20250813124311_InitialCreate")]
            ...
            modelBuilder.Entity("SistemaEstoque.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            DataCadastro = new DateTime(2025, 8, 13, 9, 43, 11, 220, DateTimeKind.Local).AddTicks(6439),
                            Descricao = "Componentes para refrigeradores",
                            Nome = "Peças de Geladeira"
                        },
                        new
                        {
                            Id = 2,
                            Ativo = true,
                            DataCadastro = new DateTime(2025, 8, 13, 9, 43, 11, 220, DateTimeKind.Local).AddTicks(6441),
                            Descricao = "Componentes para fogões",
                            Nome = "Peças de Fogão"
                        },
                        new
                        {
                            Id = 3,
                            Ativo = true,
                            DataCadastro = new DateTime(2025, 8, 13, 9, 43, 11, 220, DateTimeKind.Local).AddTicks(6442),
                            Descricao = "Componentes para microondas",
                            Nome = "Peças de Microondas"
                        },
                        new
                        {
                            Id = 4,
                            Ativo = true,
                            DataCadastro = new DateTime(2025, 8, 13, 9, 43, 11, 220, DateTimeKind.Local).AddTicks(6443),
